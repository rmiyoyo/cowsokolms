    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-12">
                <div>
                    <h1 class="text-3xl font-semibold text-gray-900 mb-2">My Courses</h1>
                    <p class="text-gray-600">Manage and track your teaching content</p>
                </div>
            ...
            @else
                <div class="lms-card p-12 text-center">
                    ...
                    <p class="text-gray-600 mb-4">No courses yet. Create your first one!</p>
                    <a href="{{ route('admin.courses.create') }}" class="lms-btn-primary inline-flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
